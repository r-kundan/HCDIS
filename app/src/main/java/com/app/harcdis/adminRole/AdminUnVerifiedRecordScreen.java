...
public class AdminUnVerifiedRecordScreen extends AppCompatActivity {
    TickerView total_unverified_count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_un_verified_record_screen);
    ...
    private void initViews() {
        ...
        adminCardAdapter = new AdminCardAdapter(AdminUnVerifiedRecordScreen.this,arrayList);
        total_unverified_count = findViewById(R.id.total_unverified_count);
        unverified_record_recyclerView = findViewById(R.id.unverified_record_recyclerView);
        no_data_found_layout = findViewById(R.id.no_data_found_layout);
        unverified_record_recyclerView.setLayoutManager(new LinearLayoutManager(AdminUnVerifiedRecordScreen.this));
        unverified_record_recyclerView.setAdapter(adminCardAdapter);

        progressDialog = new ProgressDialog(AdminUnVerifiedRecordScreen.this);
    ...
    private void fetchDataByApi(String dis, String teh, String vil) {
        arrayList.clear();
        progressDialog.show();
        ApiInterface apiInterface = RetrofitClient.getRetrofitClient(this).create(ApiInterface.class);
        Call<ResponseBody> call = apiInterface.totalUnVerifiedList(
                dis, teh, vil
        );
                    ...
                    try {
                        ...
                        if (message.equalsIgnoreCase("Success")) {
                            if (status) {
                                ...
                                total_unverified_count .setText(String.valueOf(arrayList.size()));

                            } else {
                                Toast.makeText(AdminUnVerifiedRecordScreen.this, "" + message, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(AdminUnVerifiedRecordScreen.this, "" + message, Toast.LENGTH_SHORT).show();
    ...
    private void load_village_data(String teh_name_code) {
        ...
        //progressDialog.show();
        ApiInterface apiInterface = RetrofitClient.getRetrofitClient(AdminUnVerifiedRecordScreen.this).create(ApiInterface.class);
                        ...
                        if (message.equalsIgnoreCase("sucess")) {
                            if (status) {
                                ...
                                for (int i = 0; i < result_array.length(); i++) {
                                    ...
                                    ArrayAdapter adapter = new ArrayAdapter(AdminUnVerifiedRecordScreen.this, android.R.layout.simple_spinner_item, village_name_list);
                        ...
                        if (message.equalsIgnoreCase("sucess")) {
                            if (status) {
                                ...
                                for (int i = 0; i < result_array.length(); i++) {
                                    ...
                                    ArrayAdapter adapter = new ArrayAdapter(AdminUnVerifiedRecordScreen.this, android.R.layout.simple_spinner_item, tehsil_name_list);
                                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
...
//                                    Collections.sort(dist_name_list.subList(1, dist_name_list.size()));
//                                    Collections.sort(dist_code_list.subList(1, dist_code_list.size()));

                                    ArrayAdapter adapter = new ArrayAdapter(AdminUnVerifiedRecordScreen.this, android.R.layout.simple_spinner_item, dist_name_list);
                                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
